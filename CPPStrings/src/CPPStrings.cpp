...
//        cout << "Sorry, " << word <<  " not found" << endl;
    ...
    string last_name {};
    int index_cap {};
    for (int i = 0; i < unformatted_full_name.size(); ++i) {
    	if(i!= 0 && isupper(unformatted_full_name.at(i))){
    		index_cap = i;

    	}
	}
    first_name = unformatted_full_name.substr(0,index_cap);
    last_name = unformatted_full_name.substr(index_cap,unformatted_full_name.size());
    //cout << unformatted_full_name.substr(0,index_cap) << endl;
    //cout << unformatted_full_name.substr(index_cap,unformatted_full_name.size()) << endl;
